...
using AppBase.AdoCollections;
using AppBase.Commons.Core;
...
namespace DAO
{
    ...
    public class AdoBaseDao<T> : AdoDaoSupport
    {
        ...
        public AdoBaseDao(IDbProvider dbProvider)
            : this(dbProvider, null)
        {
        }
        public AdoBaseDao(IDbProvider dbProvider, Type dataReaderWrapperType)
        {
        ...
        public static void ExecuteCommandWithTimeout(System.Data.Common.DbCommand command, int timeoutInSeconds, CommandNoReturnDelegate del)
        {
        ...
        public static T ExecuteCommandWithTimeout<T>(System.Data.Common.DbCommand command, int timeoutInSeconds, CommandDelegate<T> del)
        {
        ...
        public void DoJDBCQueryWithCancelableRowCallbackDelegate(string sql, IList<object> parValues, CancelableRowCallbackDelegate rowCallbackDelegate)
        {
        ...
        public void DoJDBCQueryWithCancelableRowCallbackDelegate(string sql, CancelableRowCallbackDelegate rowCallbackDelegate, params object[] parValues)
        {
            IDbParameters parameters;
            string selectSql = LoadGenericParameters(sql, out parameters, parValues);

            AdoTemplate.ClassicAdoTemplate.QueryWithResultSetExtractor(CommandType.Text, selectSql, new CancelableRowCallbackResultSetExtractor(rowCallbackDelegate), parameters);
        }
        ...
        public void DoJDBCQueryWithRowCallbackDelegate(string sql, RowCallbackDelegate rowCallbackDelegate, params object[] parValues)
        {
            IDbParameters parameters;
            string selectSql = LoadGenericParameters(sql, out parameters, parValues);
        ...
        public void ExecuteSqlWithoutDatabaseConnection(string sqlToExecute)
        {
            ...
            string newConnectionString =
                AdoBaseDao<T>.RemoveDatabaseFromConnectionString(DbProvider, out databaseName);
        ...
        protected string CreateInsertSqlParamText(string tableName, string semicolonSeparatedColumnNames, out string[] columnNames)
        {
        ...
        {
            string[] columnNames;
            return CreateInsertSqlParamText(tableName, semicolonSeparatedColumnNames, out columnNames);
        }
        ...
        protected IDbParameters MakeStoredProcDbParameters(string semicolonSeparatedArgNames, IList<object> args)
        {
            if (CollectionUtils.IsNullOrEmpty(args))
            {
                if (!string.IsNullOrEmpty(semicolonSeparatedArgNames))
                {
                    throw new ArgumentException(string.Format("args is null or empty, but semicolonSeparatedArgNames({0}) is not", semicolonSeparatedArgNames));
                }
                return null;
            }
        ...
        public void DoStoredProcWithRowCallbackDelegate(string procName, string semicolonSeparatedArgNames, object[] args, RowCallbackDelegate callback)
        {
        ...
        public int DoStoredProcWithArgs(string procName, string semicolonSeparatedArgNames, IList<object> args)
        {
            IDbParameters parameters = MakeStoredProcDbParameters(semicolonSeparatedArgNames, args);
            if (parameters == null)
            {
        ...
        public int FillTableFromStoredProc(DataTable table, string procName, string semicolonSeparatedArgNames, params object[] args)
        {
            IDbParameters parameters = MakeStoredProcReaderDbParameters(semicolonSeparatedArgNames, args);
            if (parameters == null)
            {
        ...
        {
            string[] columnNames;
            string insertText = CreateInsertSqlParamText(tableName, semicolonSeparatedColumnNames, out columnNames);
        ...
        public void DoBulkInsert(string tableName, string semicolonSeparatedColumnNames, GetInsertValuesDelegate del)
        {
        ...
        protected string CreateUpdateSqlParamText(string tableName, string semicolonSeparatedWhereColumns, int maxWhereParamCount, string semicolonSeparatedColumnNames)
        {
            string[] columnNames;
            return CreateUpdateSqlParamText(tableName, semicolonSeparatedWhereColumns, maxWhereParamCount, semicolonSeparatedColumnNames, out columnNames);
        }
        protected string CreateUpdateSqlParamText(string tableName, string whereColumn, string semicolonSeparatedColumnNames)
        {
            string[] columnNames;
            return CreateUpdateSqlParamText(tableName, whereColumn, 1, semicolonSeparatedColumnNames, out columnNames);
        }
        protected void AppendWhereString(string semicolonSeparatedWhereColumns, int maxWhereParamCount, StringBuilder sb)
        {
        ...
        protected string CreateUpdateSqlParamText(string tableName, string semicolonSeparatedWhereColumns, int maxWhereParamCount, string semicolonSeparatedColumnNames, out string[] columnNames)
        {
            if (string.IsNullOrEmpty(tableName))
            {
                throw new ArgumentException("tableName is empty");
        ...
        public void DoSimpleUpdateOne(string tableName, string semicolonSeparatedWhereColumns, IList<object> whereValues, string semicolonSeparatedColumnNames, params object[] values)
        {
            DoSimpleUpdate(tableName, semicolonSeparatedWhereColumns, null, whereValues, semicolonSeparatedColumnNames, 1, values);
        }
        public bool DoSimpleInsertOrUpdateOne(string tableName, string semicolonSeparatedWhereColumns, IList<object> whereValues, string semicolonSeparatedColumnNames, params object[] values)
        {
            try
            {
